...
public class OtherGuardianFrag
		...
		com.handmark.pulltorefresh.library.PullToRefreshBase.OnRefreshListener2
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("EldYoungAndroidApp.Fragments.MainTab.Guardian.OtherGuardianFrag, EldYoungAndroidApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", OtherGuardianFrag.class, __md_methods);
	}


	public OtherGuardianFrag () throws java.lang.Throwable
	{
		super ();
		if (getClass () == OtherGuardianFrag.class)
			mono.android.TypeManager.Activate ("EldYoungAndroidApp.Fragments.MainTab.Guardian.OtherGuardianFrag, EldYoungAndroidApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
