...
namespace Com.Nostra13.Universalimageloader.Cache.Memory.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']"
	[global::Android.Runtime.Register ("com/nostra13/universalimageloader/cache/memory/impl/LimitedAgeMemoryCache", DoNotGenerateAcw=true)]
	public partial class LimitedAgeMemoryCache : global::Java.Lang.Object, global::Com.Nostra13.Universalimageloader.Cache.Memory.IMemoryCache {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/nostra13/universalimageloader/cache/memory/impl/LimitedAgeMemoryCache", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (LimitedAgeMemoryCache); }
		}

		protected LimitedAgeMemoryCache (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Lcom_nostra13_universalimageloader_cache_memory_MemoryCache_J;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/constructor[@name='LimitedAgeMemoryCache' and count(parameter)=2 and parameter[1][@type='com.nostra13.universalimageloader.cache.memory.MemoryCache'] and parameter[2][@type='long']]"
		[Register (".ctor", "(Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;J)V", "")]
		public unsafe LimitedAgeMemoryCache (global::Com.Nostra13.Universalimageloader.Cache.Memory.IMemoryCache p0, long p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (LimitedAgeMemoryCache)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;J)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;J)V", __args);
					return;
				}

				if (id_ctor_Lcom_nostra13_universalimageloader_cache_memory_MemoryCache_J == IntPtr.Zero)
					id_ctor_Lcom_nostra13_universalimageloader_cache_memory_MemoryCache_J = JNIEnv.GetMethodID (class_ref, "<init>", "(Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;J)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Lcom_nostra13_universalimageloader_cache_memory_MemoryCache_J, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Lcom_nostra13_universalimageloader_cache_memory_MemoryCache_J, __args);
			} finally {
			}
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Nostra13.Universalimageloader.Cache.Memory.Impl.LimitedAgeMemoryCache __this = global::Java.Lang.Object.GetObject<global::Com.Nostra13.Universalimageloader.Cache.Memory.Impl.LimitedAgeMemoryCache> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.Clear ();
		}
#pragma warning restore 0169

		static IntPtr id_clear;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/method[@name='clear' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/method[@name='get' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/method[@name='keys' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/method[@name='put' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='android.graphics.Bitmap']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.memory.impl']/class[@name='LimitedAgeMemoryCache']/method[@name='remove' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
