		...
		public virtual unsafe void OnLoadingCancelled (string p0, global::Android.Views.View p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onLoadingCancelled", "(Ljava/lang/String;Landroid/view/View;)V"), __args);
			} finally {
		...
		public virtual unsafe void OnLoadingComplete (string p0, global::Android.Views.View p1, global::Android.Graphics.Bitmap p2)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onLoadingComplete", "(Ljava/lang/String;Landroid/view/View;Landroid/graphics/Bitmap;)V"), __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
		}
		...
		public virtual unsafe void OnLoadingFailed (string p0, global::Android.Views.View p1, global::Com.Nostra13.Universalimageloader.Core.Assist.FailReason p2)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onLoadingFailed", "(Ljava/lang/String;Landroid/view/View;Lcom/nostra13/universalimageloader/core/assist/FailReason;)V"), __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
		}
		...
		public virtual unsafe void OnLoadingStarted (string p0, global::Android.Views.View p1)
		{
			...
			try {
				...
				if (GetType () == ThresholdType)
					...
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "onLoadingStarted", "(Ljava/lang/String;Landroid/view/View;)V"), __args);
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
		}
