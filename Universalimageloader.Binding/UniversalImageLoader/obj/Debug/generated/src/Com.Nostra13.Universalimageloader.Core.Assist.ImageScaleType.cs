...
namespace Com.Nostra13.Universalimageloader.Core.Assist {
	...
	public sealed partial class ImageScaleType : global::Java.Lang.Enum {
		...
		static IntPtr NONE_SAFE_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.core.assist']/class[@name='ImageScaleType']/field[@name='NONE_SAFE']"
		[Register ("NONE_SAFE")]
		public static global::Com.Nostra13.Universalimageloader.Core.Assist.ImageScaleType NoneSafe {
			get {
				if (NONE_SAFE_jfieldId == IntPtr.Zero)
					NONE_SAFE_jfieldId = JNIEnv.GetStaticFieldID (class_ref, "NONE_SAFE", "Lcom/nostra13/universalimageloader/core/assist/ImageScaleType;");
				IntPtr __ret = JNIEnv.GetStaticObjectField (class_ref, NONE_SAFE_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Com.Nostra13.Universalimageloader.Core.Assist.ImageScaleType> (__ret, JniHandleOwnership.TransferLocalRef);
			}
		}
		...
		public static unsafe global::Com.Nostra13.Universalimageloader.Core.Assist.ImageScaleType ValueOf (string p0)
		{
			...
			try {
				...
				global::Com.Nostra13.Universalimageloader.Core.Assist.ImageScaleType __ret = global::Java.Lang.Object.GetObject<global::Com.Nostra13.Universalimageloader.Core.Assist.ImageScaleType> (JNIEnv.CallStaticObjectMethod  (class_ref, id_valueOf_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
		...
		public static unsafe global::Com.Nostra13.Universalimageloader.Core.Assist.ImageScaleType[] Values ()
		{
