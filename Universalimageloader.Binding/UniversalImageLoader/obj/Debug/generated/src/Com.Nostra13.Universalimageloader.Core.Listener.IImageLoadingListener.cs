...
namespace Com.Nostra13.Universalimageloader.Core.Listener {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.nostra13.universalimageloader.core.listener']/interface[@name='ImageLoadingListener']"
	[Register ("com/nostra13/universalimageloader/core/listener/ImageLoadingListener", "", "Com.Nostra13.Universalimageloader.Core.Listener.IImageLoadingListenerInvoker")]
	public partial interface IImageLoadingListener : IJavaObject {

		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.core.listener']/interface[@name='ImageLoadingListener']/method[@name='onLoadingCancelled' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='android.view.View']]"
		[Register ("onLoadingCancelled", "(Ljava/lang/String;Landroid/view/View;)V", "GetOnLoadingCancelled_Ljava_lang_String_Landroid_view_View_Handler:Com.Nostra13.Universalimageloader.Core.Listener.IImageLoadingListenerInvoker, UniversalImageLoader")]
		void OnLoadingCancelled (string p0, global::Android.Views.View p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.core.listener']/interface[@name='ImageLoadingListener']/method[@name='onLoadingComplete' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='android.view.View'] and parameter[3][@type='android.graphics.Bitmap']]"
		[Register ("onLoadingComplete", "(Ljava/lang/String;Landroid/view/View;Landroid/graphics/Bitmap;)V", "GetOnLoadingComplete_Ljava_lang_String_Landroid_view_View_Landroid_graphics_Bitmap_Handler:Com.Nostra13.Universalimageloader.Core.Listener.IImageLoadingListenerInvoker, UniversalImageLoader")]
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.core.listener']/interface[@name='ImageLoadingListener']/method[@name='onLoadingStarted' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='android.view.View']]"
		[Register ("onLoadingStarted", "(Ljava/lang/String;Landroid/view/View;)V", "GetOnLoadingStarted_Ljava_lang_String_Landroid_view_View_Handler:Com.Nostra13.Universalimageloader.Core.Listener.IImageLoadingListenerInvoker, UniversalImageLoader")]
		void OnLoadingStarted (string p0, global::Android.Views.View p1);

	}

	[global::Android.Runtime.Register ("com/nostra13/universalimageloader/core/listener/ImageLoadingListener", DoNotGenerateAcw=true)]
	internal class IImageLoadingListenerInvoker : global::Java.Lang.Object, IImageLoadingListener {

		static IntPtr java_class_ref = JNIEnv.FindClass ("com/nostra13/universalimageloader/core/listener/ImageLoadingListener");
		IntPtr class_ref;
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.nostra13.universalimageloader.core.listener.ImageLoadingListener"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			global::Com.Nostra13.Universalimageloader.Core.Listener.IImageLoadingListener __this = global::Java.Lang.Object.GetObject<global::Com.Nostra13.Universalimageloader.Core.Listener.IImageLoadingListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public unsafe void OnLoadingCancelled (string p0, global::Android.Views.View p1)
		{
			...
			JNIEnv.CallVoidMethod (Handle, id_onLoadingCancelled_Ljava_lang_String_Landroid_view_View_, __args);
...
#pragma warning restore 0169
		...
		public unsafe void OnLoadingComplete (string p0, global::Android.Views.View p1, global::Android.Graphics.Bitmap p2)
		{
			...
			JNIEnv.CallVoidMethod (Handle, id_onLoadingComplete_Ljava_lang_String_Landroid_view_View_Landroid_graphics_Bitmap_, __args);
			JNIEnv.DeleteLocalRef (native_p0);
		}
...
#pragma warning restore 0169
		...
		public unsafe void OnLoadingFailed (string p0, global::Android.Views.View p1, global::Com.Nostra13.Universalimageloader.Core.Assist.FailReason p2)
		{
			...
			__args [1] = new JValue (p1);
			__args [2] = new JValue (p2);
			JNIEnv.CallVoidMethod (Handle, id_onLoadingFailed_Ljava_lang_String_Landroid_view_View_Lcom_nostra13_universalimageloader_core_assist_FailReason_, __args);
			JNIEnv.DeleteLocalRef (native_p0);
		}
...
#pragma warning restore 0169
		...
		public unsafe void OnLoadingStarted (string p0, global::Android.Views.View p1)
		{
			...
			__args [0] = new JValue (native_p0);
			__args [1] = new JValue (p1);
			JNIEnv.CallVoidMethod (Handle, id_onLoadingStarted_Ljava_lang_String_Landroid_view_View_, __args);
			JNIEnv.DeleteLocalRef (native_p0);
		}
	...
	[global::Android.Runtime.Register ("mono/com/nostra13/universalimageloader/core/listener/ImageLoadingListenerImplementor")]
	internal sealed partial class IImageLoadingListenerImplementor : global::Java.Lang.Object, IImageLoadingListener {

		object sender;

		public IImageLoadingListenerImplementor (object sender)
			: base (
				global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/nostra13/universalimageloader/core/listener/ImageLoadingListenerImplementor", "()V"),
