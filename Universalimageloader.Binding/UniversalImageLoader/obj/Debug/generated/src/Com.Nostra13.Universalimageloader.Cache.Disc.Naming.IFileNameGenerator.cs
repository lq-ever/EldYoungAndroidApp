...
namespace Com.Nostra13.Universalimageloader.Cache.Disc.Naming {
	...
	public partial interface IFileNameGenerator : IJavaObject {
		...
		[Register ("generate", "(Ljava/lang/String;)Ljava/lang/String;", "GetGenerate_Ljava_lang_String_Handler:Com.Nostra13.Universalimageloader.Cache.Disc.Naming.IFileNameGeneratorInvoker, UniversalImageLoader")]
...
#pragma warning restore 0169
		...
		public unsafe string Generate (string p0)
		{
			...
			string __ret = JNIEnv.GetString (JNIEnv.CallObjectMethod (Handle, id_generate_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
