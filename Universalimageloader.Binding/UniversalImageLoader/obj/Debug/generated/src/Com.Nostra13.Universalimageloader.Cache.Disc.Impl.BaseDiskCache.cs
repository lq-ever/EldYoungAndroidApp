...
namespace Com.Nostra13.Universalimageloader.Cache.Disc.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']"
	[global::Android.Runtime.Register ("com/nostra13/universalimageloader/cache/disc/impl/BaseDiskCache", DoNotGenerateAcw=true)]
	public abstract partial class BaseDiskCache : global::Java.Lang.Object, global::Com.Nostra13.Universalimageloader.Cache.Disc.IDiskCache {


		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/field[@name='DEFAULT_BUFFER_SIZE']"
		[Register ("DEFAULT_BUFFER_SIZE")]
		public const int DefaultBufferSize = (int) 32768;

		static IntPtr DEFAULT_COMPRESS_FORMAT_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/field[@name='DEFAULT_COMPRESS_FORMAT']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/field[@name='DEFAULT_COMPRESS_QUALITY']"
		[Register ("DEFAULT_COMPRESS_QUALITY")]
		public const int DefaultCompressQuality = (int) 100;

		static IntPtr bufferSize_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/field[@name='bufferSize']"
		[Register ("bufferSize")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/field[@name='cacheDir']"
		[Register ("cacheDir")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/field[@name='compressFormat']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/field[@name='compressQuality']"
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/field[@name='fileNameGenerator']"
		...
		static IntPtr reserveCacheDir_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/field[@name='reserveCacheDir']"
		[Register ("reserveCacheDir")]
		protected global::Java.IO.File ReserveCacheDir {
			get {
				if (reserveCacheDir_jfieldId == IntPtr.Zero)
					reserveCacheDir_jfieldId = JNIEnv.GetFieldID (class_ref, "reserveCacheDir", "Ljava/io/File;");
				IntPtr __ret = JNIEnv.GetObjectField (Handle, reserveCacheDir_jfieldId);
				return global::Java.Lang.Object.GetObject<global::Java.IO.File> (__ret, JniHandleOwnership.TransferLocalRef);
			}
			set {
				if (reserveCacheDir_jfieldId == IntPtr.Zero)
				...
				IntPtr native_value = JNIEnv.ToLocalJniHandle (value);
				try {
					JNIEnv.SetField (Handle, reserveCacheDir_jfieldId, native_value);
				} finally {
					JNIEnv.DeleteLocalRef (native_value);
				}
			}
		...
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/nostra13/universalimageloader/cache/disc/impl/BaseDiskCache", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BaseDiskCache); }
		}

		protected BaseDiskCache (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_io_File_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/constructor[@name='BaseDiskCache' and count(parameter)=1 and parameter[1][@type='java.io.File']]"
		[Register (".ctor", "(Ljava/io/File;)V", "")]
		public unsafe BaseDiskCache (global::Java.IO.File p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (BaseDiskCache)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/constructor[@name='BaseDiskCache' and count(parameter)=3 and parameter[1][@type='java.io.File'] and parameter[2][@type='java.io.File'] and parameter[3][@type='com.nostra13.universalimageloader.cache.disc.naming.FileNameGenerator']]"
		[Register (".ctor", "(Ljava/io/File;Ljava/io/File;Lcom/nostra13/universalimageloader/cache/disc/naming/FileNameGenerator;)V", "")]
		public unsafe BaseDiskCache (global::Java.IO.File p0, global::Java.IO.File p1, global::Com.Nostra13.Universalimageloader.Cache.Disc.Naming.IFileNameGenerator p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/constructor[@name='BaseDiskCache' and count(parameter)=2 and parameter[1][@type='java.io.File'] and parameter[2][@type='java.io.File']]"
		[Register (".ctor", "(Ljava/io/File;Ljava/io/File;)V", "")]
		public unsafe BaseDiskCache (global::Java.IO.File p0, global::Java.IO.File p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Java.IO.File Directory {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='getDirectory' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='clear' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='close' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='get' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning disable 0169
		static Delegate GetGetFile_Ljava_lang_String_Handler ()
		{
			if (cb_getFile_Ljava_lang_String_ == null)
				cb_getFile_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((Func<IntPtr, IntPtr, IntPtr, IntPtr>) n_GetFile_Ljava_lang_String_);
		...
		static IntPtr n_GetFile_Ljava_lang_String_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
		{
			global::Com.Nostra13.Universalimageloader.Cache.Disc.Impl.BaseDiskCache __this = global::Java.Lang.Object.GetObject<global::Com.Nostra13.Universalimageloader.Cache.Disc.Impl.BaseDiskCache> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			string p0 = JNIEnv.GetString (native_p0, JniHandleOwnership.DoNotTransfer);
			IntPtr __ret = JNIEnv.ToLocalJniHandle (__this.GetFile (p0));
			return __ret;
		}
#pragma warning restore 0169

		static IntPtr id_getFile_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='getFile' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("getFile", "(Ljava/lang/String;)Ljava/io/File;", "GetGetFile_Ljava_lang_String_Handler")]
		protected virtual unsafe global::Java.IO.File GetFile (string p0)
		{
			if (id_getFile_Ljava_lang_String_ == IntPtr.Zero)
				id_getFile_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "getFile", "(Ljava/lang/String;)Ljava/io/File;");
			IntPtr native_p0 = JNIEnv.NewString (p0);
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (native_p0);
				...
				global::Java.IO.File __ret;
				if (GetType () == ThresholdType)
					__ret = global::Java.Lang.Object.GetObject<global::Java.IO.File> (JNIEnv.CallObjectMethod  (Handle, id_getFile_Ljava_lang_String_, __args), JniHandleOwnership.TransferLocalRef);
				else
					__ret = global::Java.Lang.Object.GetObject<global::Java.IO.File> (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "getFile", "(Ljava/lang/String;)Ljava/io/File;"), __args), JniHandleOwnership.TransferLocalRef);
				return __ret;
			} finally {
				JNIEnv.DeleteLocalRef (native_p0);
			}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='remove' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='save' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='android.graphics.Bitmap']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='save' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.io.InputStream'] and parameter[3][@type='com.nostra13.universalimageloader.utils.IoUtils.CopyListener']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='setBufferSize' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='setCompressFormat' and count(parameter)=1 and parameter[1][@type='android.graphics.Bitmap.CompressFormat']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.nostra13.universalimageloader.cache.disc.impl']/class[@name='BaseDiskCache']/method[@name='setCompressQuality' and count(parameter)=1 and parameter[1][@type='int']]"
	...
	[global::Android.Runtime.Register ("com/nostra13/universalimageloader/cache/disc/impl/BaseDiskCache", DoNotGenerateAcw=true)]
	internal partial class BaseDiskCacheInvoker : BaseDiskCache {

		public BaseDiskCacheInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer) {}

		protected override global::System.Type ThresholdType {
			get { return typeof (BaseDiskCacheInvoker); }
		}
